...
export function getDefaultMarker(color="#000000") {
    const svgTemplate = `
...
export function getDroneIcon(color="#000000") {
...
export function getLandingPadIcon(color="#000000") {
    const landing_pad_svg = `<svg fill="${color}" viewBox="0 0 32 32" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg">`
    + '<defs>'
    + '<style>'
    + '.cls-1 {fill: none;}'
    + '</style>'
