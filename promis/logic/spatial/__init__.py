...
from promis.logic.spatial.faces import Faces
...
__all__ = ["Approaches", "Crosses", "Depth", "Distance", "Enters", "Exits", "Faces", "Intersects", "Follows", "Opposes", "Over", "Relation", "ScalarRelation"]
