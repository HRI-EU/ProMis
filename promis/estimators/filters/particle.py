####
# TODO:
# This file is mostly taken from https://github.com/johnhw/pfilter/blob/master/pfilter/pfilter.py
####
...
class ParticleFilter:
    ...
    def update(self, observed=None, **kwargs):
        ...
        if self.internal_weight_fn is not None:
            internal_weights = self.internal_weight_fn(self.particles, observed, **kwargs)
        ...
        self.weight_entropy = np.sum(nonzero_weights * np.log2(nonzero_weights))
